// ============================================================
// AureliaToonLite.shader — toon TANPA outline.
//
// Pencahayaan 100% sama dengan AureliaToon (fungsi bersama di
// AureliaToonLighting.hlsl). Dipakai untuk:
//   * lapisan wajah transparan (alis, bulu mata, iris — outline
//     di sana justru merusak wajah),
//   * preset Rendah: QualityApplier menukar semua material toon
//     ke Lite sehingga 1 draw call + 1x vertex per material
//     hilang tanpa mengubah satu warna pun.
// ============================================================
Shader "Aurelia/ToonLite"
{
    Properties
    {
